...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  watch: {
    'form.login.value': function formLoginValue(val, oldVal) {
      if (!this.$v.form.login.value.$dirty) this.$v.form.login.value.$touch();
      console.log(this.$v.form.login.value);
      this.form.login.state = !this.$v.form.login.value.$invalid;
    }
  },
  methods: {
    ...
    handleSubmit: function handleSubmit() {
      ...
      this.$refs.formValidObs.validate().then(function (success) {
        if (!success) {
          return;
        }
    ...
    form: {
      login: {
        value: {
          ...
          max: Object(vuelidate_lib_validators__WEBPACK_IMPORTED_MODULE_0__["maxLength"])(20)
        }
      },
      password: {
        value: {
      ...
      _c(
        ...
        [
          _c("router-link", { attrs: { to: { name: "index" } } }, [
            _c("a", { staticClass: "navbar-brand" }, [_vm._v("Allete")])
          ]),
          _vm._v(" "),
...
var staticRenderFns = [
  ...
  function() {
    ...
    return _c("form", { staticClass: "form-inline search-form" }, [
      _c("input", {
        staticClass:
          "form-control mr-sm-2 border border-dark custom-border-style search-input",
  ...
  return _c(
    ...
    [
      ...
      _c(
        "b-modal",
        {
          attrs: { id: "modal", title: "Вход" },
          on: { toggle: _vm.resetModal, ok: _vm.handleOk },
          scopedSlots: _vm._u([
            {
              key: "modal-footer",
              fn: function(ref) {
                ...
                [
                  ...
                  _c(
                    ...
                    [
                      _vm._v(
                        "\n                    " +
                          _vm._s(_vm.$v.form.login.value.required) +
                          "\n                "
                      )
                    ]
                  )
                ...
                [
                  ...
                  _c(
                    ...
                    [
                      _vm._v(
                        "\n                    " +
                          _vm._s(_vm.$v.form.password.value.required) +
                          "\n                "
                      )
                    ]
                  )
